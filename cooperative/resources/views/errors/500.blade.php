...
<head>
    ...
    <link rel="stylesheet" href="/assets/dist/css/web-style.css">
...
<div class="container flex-row flex-1 text-center mt-5" style="min-height: 300px;">
    <h1>خطایی در سرور رخ داده است.</h1>
</div>
