...
<div class="container">
        ...
        @foreach($advertisings as $advertising)
            <div class="col-md-3 mt-5">
                <div class="advertising-body">
                    <div class="advertising-header mt-2 text-center text-white"><h4 style="font-family: Vazir !important;">
                            {!! $advertising->title !!}
                        </h4></div>
                    <div class="advertising-img text-center p-2">
                        <img src="/cooperative/public{{ $advertising->image }}" class="img-rounded" width="100%" height="200"   alt="">
                    </div>
                    
                    <div class="advertising-desc" style="height:200px;"><h6>
                            {!! substr($advertising->description, 0, 100) !!}
                        </h6></div>
    ...
    <div class="col-md-2 flex-row mt-5">
