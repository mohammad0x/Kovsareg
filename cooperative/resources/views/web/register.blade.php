...
<main>
    ...
    <div class="register-form">
        @if($errors->any())
            ...
            @endforeach
        @endif
        @if(\Illuminate\Support\Facades\Session::has('error'))<div class="text-center" style="color: #d50000"> {{\Illuminate\Support\Facades\Session::get('error')}}</div>@endif

        <form action="{{route('web.register_post')}}" method="post" enctype="application/x-www-form-urlencoded">
            @csrf
            ...
            <div class="form-group">
                <div class="mb-3">
                    ...
                    <textarea   rows="3" class="form-control" placeholder="آدرس"  type="text" name="address" style="width: 100%;padding: 5px 10px;"></textarea>
                </div>
