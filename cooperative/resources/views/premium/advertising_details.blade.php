                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">جزئیات آگهی</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <p>{{number_format($advertising->price)}}</p>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                <hr>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <textarea type="text" id="editor" name="description">{{$advertising->description}}</textarea>
                                ...
                                <hr>
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <img src="{{$advertising->image}}" width="400px" height="400px">

                                        </div>
                                        <hr>
                                        <!-- /.input group -->
                                        @if($advertising->category!= null)
                                        <div class="form-group col-md-4">
                                            <label>دسته آگهی:</label>
                                            <p>{{$advertising->category->name}}</p>
                                        </div>
