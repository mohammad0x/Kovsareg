                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endforeach
                                @endif
                                <form action="{{route('store_advertising.premium')}}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <textarea type="text"  cols="30" rows="10"  class="form-control" name="description"></textarea>
