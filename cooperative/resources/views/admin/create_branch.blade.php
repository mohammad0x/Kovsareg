...
<head>
    ...
    <link rel="stylesheet" href="/assets/plugins/ckeditor/ckeditor.js">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">ثبت شعبه جدید</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ثبت شعبه جدید</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                ...
                                @if($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form action="{{route('store_branch.admin')}}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <textarea type="text" class="form-control" name="subs" rows="5"></textarea>
                                        </div>

                                    </div>
                                    <div>
                                        <button class="btn btn-info mt-2" type="submit">ایجاد</button>
                                    </div>
                                </form>
                            </div>
                        </div>
