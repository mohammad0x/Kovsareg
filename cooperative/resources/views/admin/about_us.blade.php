    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">درباره ما</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if(\Illuminate\Support\Facades\Session::has('error'))
                                    <div
                                        class="alert alert-danger">{{\Illuminate\Support\Facades\Session::get('error')}}</div>
                                @endif
                                <form action="{{route('update_about_us.admin')}}" enctype="multipart/form-data"
                                      method="post">
                                    @csrf
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="input-group">
                                            <textarea type="text" id="editor" cols="30" rows="10" class="form-control"
                                    ...
                                    <div class="form-group col-md-12">
                                        <img src="{{$aboutUs->image}}" width="200" height="200"/>
                                        <br>
                                        <br>
                                        <label>تصویر :</label>
