    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">همه تراکنش ها</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($posts as $post)
                                        <tr>
                                            ...
                                            <td><img src="/cooperative/public{{$post->image}}" alt="" width="100" height="100"></td>
                                            <td>@if($post->status==0) تایید نشده@elseتایید شده@endif</td>
                                            <td><a href="{{route('post_details.admin',$post->id)}}" class="btn btn-info">بررسی</a></td>
                                        </tr>
                                    @endforeach
