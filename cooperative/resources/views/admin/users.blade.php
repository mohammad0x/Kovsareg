    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">کاربران معمولی</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
...
@foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>{{$user->mobile}}</td>
                                        <td>{{$user->address}}</td>
                                        <td>@if($user->role == 0)کاربر معمولی @elseکاربر ویژه @endif</td>
                                        <td>@if($user->branch){{$user->branch->name}}@endif</td>
                                        <td><a href="{{route('user_details.admin',$user->id)}}" class="btn btn-info">بررسی</a></td>
                                    </tr>
@endforeach
