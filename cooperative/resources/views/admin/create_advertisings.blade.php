    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">ثبت آگهی</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ثبت آگهی جدید</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                @if($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form action="{{route('store_advertising.admin')}}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            <textarea type="text" id="editor" cols="30" rows="10" class="form-control" name="description"></textarea>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" style="width: 100%;" name="verified">
                                            <option selected="selected" value="1">تایید شده</option>
                                            <option selected="selected" value="0">تایید نشده</option>
                                        </select>
                                    </div>
