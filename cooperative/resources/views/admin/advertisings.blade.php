    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">لیست آگهی</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            @if(\Illuminate\Support\Facades\Session::has('success'))
                                <div class="alert alert-success">{{\Illuminate\Support\Facades\Session::get('True')}}</div>
                            @endif
                            @if(\Illuminate\Support\Facades\Session::has('error'))
                                <div class="alert alert-danger">{{\Illuminate\Support\Facades\Session::get('False')}}</div>
                            @endif
                            <div class="card-body">
...
@foreach($advertisings as $advertising)
                                    <tr>
                                        ...
                                        <td>@if($advertising->user == null){{$advertising->admin->name.' '.$advertising->admin->family}} @else{{$advertising->user->name.' '.$advertising->user->family }}@endif</td>
                                        <td>{{$advertising->title}}</td>
                                        <td>{{number_format((float)$advertising->price)}}</td>
                                        <td>@if($advertising->verified == 0)تایید نشده @elseتایید شده @endif</td>
                                        <td><a href="{{route('advertising_details.admin',$advertising->id)}}" class="btn btn-info">بررسی</a></td>
                                    </tr>
@endforeach
                                    </tbody>
                                </table>
