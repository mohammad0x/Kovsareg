    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">ثبت پست</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if($errors->any())
                                    ...
                                    @endforeach
                                @endif
                                <form action="{{route('store_post.admin')}}" enctype="multipart/form-data" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" style="width: 100%;" name="status">
                                            <option selected="selected" value="1">انتشار</option>
                                            <option selected="selected" value="0 ">پیش نویس</option>
                                        </select>
                                    </div>
